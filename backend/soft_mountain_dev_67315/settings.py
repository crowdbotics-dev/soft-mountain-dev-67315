"""
Django settings for soft_mountain_dev_67315 project.
...
ROOT_URLCONF = 'soft_mountain_dev_67315.urls'
...
WSGI_APPLICATION = 'soft_mountain_dev_67315.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_mountain_dev_67315 API",
    "DESCRIPTION": "API documentation for soft_mountain_dev_67315 App",
    "VERSION": "v1",
}
